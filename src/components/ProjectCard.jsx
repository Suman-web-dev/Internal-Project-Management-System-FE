...
const ProjectCard = ({ project, onClick, onDelete, onEdit, canDelete, canEdit }) => {
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(project.status)} flex-shrink-0`}>
        ...
        <div className="flex items-center space-x-2">
          {canEdit && (
            <button
              ...
              className="text-gray-400 hover:text-blue-500 focus:outline-none transition-colors p-1 rounded hover:bg-blue-50"
              title="Edit project"
            >
